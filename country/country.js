...
description.textContent = "Below are details about each balablue in the world";
description.classList.add("paragraph_title");
...
countries.forEach((country) => {
  ...
  languages.textContent = `Language(s):${country.languages.join(", ")}`;

  // Population
  const population = document.createElement("p");
  const formattedPop = country.population.toLocaleString();

  population.textContent = formattedPop;
